...
<div class="row">
    <div class="col-md-3">
        ...
        {!! Form::text('domain', isset($domain) ? $domain : null, array('class' => 'form-control')) !!}
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-2">
        ...
        {!! Form::select('type', $searchValidInputTypes, isset($type) ? $type : 'ANY_TYPE', ['class' => 'form-control']) !!}
    </div>
    <div class="col-md-3">
        {!! Form::label('data', trans('record/model.data'), array('class' => 'control-label')) !!}
        {!! Form::text('data', isset($data) ? $data : null, array('class' => 'form-control')) !!}
    </div>
    <div class="col-md-1">

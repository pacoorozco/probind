...
<div class="box box-solid">
    <div class="box-header">
        <h3 class="box-title">{{ __('zone/model.types.slave') }}</h3>
    </div>
    <div class="box-body">
        ...
        <div class="form-group {{ $errors->has('master_server') ? 'has-error' : '' }}">
            {!! Form::label('master_server', __('zone/model.master_server'), array('class' => 'control-label required')) !!}
            <div class="controls">
    ...
    {!! Form::button('<i class="fa fa-floppy-o"></i> ' . __('general.save'), array('type' => 'submit', 'class' => 'btn btn-success', 'id' => 'slave_zone')) !!}
    <!-- ./ form actions -->
    </div>
</div>
{!! Form::close() !!}

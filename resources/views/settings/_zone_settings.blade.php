...
<div class="form-group {{ $errors->has('zone_default_mname') ? 'has-error' : '' }}">
    ...
    <div class="controls">
        {!! Form::text('zone_default_mname', Registry::get('zone_default_mname'), array('class' => 'form-control', 'required' => 'required')) !!}
...
<div class="form-group {{ $errors->has('zone_default_rname') ? 'has-error' : '' }}">
    ...
    <div class="controls">
        {!! Form::email('zone_default_rname', Registry::get('zone_default_rname'), array('class' => 'form-control', 'required' => 'required')) !!}
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('zone_default_refresh') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('zone_default_refresh', Registry::get('zone_default_refresh'), array('class' => 'form-control', 'required' => 'required')) !!}
    ...
    <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('zone_default_retry') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('zone_default_retry', Registry::get('zone_default_retry'), array('class' => 'form-control', 'required' => 'required')) !!}
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('zone_default_expire') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('zone_default_expire', Registry::get('zone_default_expire'), array('class' => 'form-control', 'required' => 'required')) !!}
    ...
    <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('zone_default_negative_ttl') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('zone_default_negative_ttl', Registry::get('zone_default_negative_ttl'), array('class' => 'form-control', 'required' => 'required')) !!}
...
<div class="form-group {{ $errors->has('zone_default_default_ttl') ? 'has-error' : '' }}">
    ...
    <div class="controls">
        {!! Form::number('zone_default_default_ttl', Registry::get('zone_default_default_ttl'), array('class' => 'form-control', 'required' => 'required')) !!}

...
return [
    ...
    'activity' => [
        'created' => 'Zone <strong>:domain</strong> was created.',
        'updated' => 'Zone <strong>:domain</strong> was modified.',
        'deleted' => 'Zone <strong>:domain</strong> was deleted.',
    ],

    'resource_records' => 'The zone <strong>:zone</strong> contains <strong>:number resource records</strong>.',

    'settings' => [
        'custom' => 'Using customized zone settings.',
        'default' => 'Using default zone settings.',
    ],
];
